...
const GRE_MAP_LAYOUT = [
    {num:8,  points:"120,74 205,56 258,95 245,170 150,177 114,150", cx:180, cy:112, cityY:135, valueY:156},
    {num:4,  points:"392,76 462,98 468,179 390,158 330,122", cx:404, cy:122, cityY:145, valueY:166},
    {num:2,  points:"462,98 556,92 610,145 585,214 476,180 468,179", cx:540, cy:150, cityY:173, valueY:194},
    {num:14, points:"556,92 650,104 700,172 672,247 585,214 610,145", cx:644, cy:165, cityY:188, valueY:209},
    {num:9,  points:"106,149 151,178 244,170 266,242 177,263 104,227", cx:170, cy:208, cityY:231, valueY:252},
    {num:7,  points:"244,170 330,122 390,158 384,238 272,238 266,242", cx:330, cy:202, cityY:225, valueY:246},
    {num:3,  points:"384,238 476,180 585,214 588,294 470,325 392,310", cx:486, cy:259, cityY:282, valueY:303},
    {num:15, points:"588,294 585,214 672,247 700,336 650,372 588,324", cx:647, cy:282, cityY:305, valueY:326},
    {num:1,  points:"672,247 745,217 784,260 772,366 700,336", cx:741, cy:279, cityY:302, valueY:323},
    {num:10, points:"104,227 177,263 272,260 260,336 165,354 98,312", cx:170, cy:286, cityY:309, valueY:330},
    {num:13, points:"272,238 384,238 400,327 332,384 260,336 272,260", cx:336, cy:277, cityY:300, valueY:321},
    {num:6,  points:"332,384 400,327 474,341 476,434 418,463 304,443", cx:394, cy:393, cityY:416, valueY:437},
    {num:12, points:"474,341 588,294 650,336 640,434 574,428 476,434", cx:560, cy:366, cityY:389, valueY:410},
    {num:16, points:"650,336 700,336 772,366 768,428 694,438 640,434", cx:705, cy:382, cityY:405, valueY:426},
    {num:11, points:"165,354 260,336 304,443 252,445 174,452 130,410", cx:214, cy:403, cityY:426, valueY:447},
    {num:5,  points:"476,434 574,428 612,511 552,553 440,548 418,463", cx:508, cy:475, cityY:498, valueY:519}
];
...
function renderGrePerformance(rows) {
    ...
    target.innerHTML = `
        <svg class="gre-map-svg" viewBox="60 34 760 540" role="img" aria-label="Mapa por GRE">
            ${shapes}
        </svg>`;
}
